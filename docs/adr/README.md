...
| [ADR-004](ADR-004-anchoring-strings-composed-in-js.md) | whether a dictionary key whose text is composed in JavaScript gets an anchor in the markup | **Proposed**, 2026-09-01 |
